 ...
 * @constructor
 * @param {Number} delay The delay between each speculative execution. Must be strictly positive.
...
function ConstantSpeculativeExecutionPolicy(delay, maxSpeculativeExecutions) {
  if (!(delay > 0)) {
    throw new errors.ArgumentError('delay must be a positive number');
  }
